...
func NewApplication(prodCollection, userCollection *mongo.Collection) *Applications{
	return &Applications{
...
//struct method
func  (app *Applications)AddToCart() gin.HandlerFunc{
...
func (app *Applications)RemoveItem() gin.HandlerFunc{
	return func(c *gin.Context) {
		productQueryID := c.Query("id")
		if productQueryID == "" {
...
func  (app *Applications)BuyFromCart() gin.HandlerFunc {
	return func(c *gin.Context){
...
func (app *Applications)InstantBuy() gin.HandlerFunc {
